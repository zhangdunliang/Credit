...
public class HttpConnection extends Connection {
	...
	Response getResponse() throws IOException {
		String serviceId = mHttpUrlConnection.getRequestProperty("serviceId");
		if (null == serviceId || TextUtils.isEmpty(serviceId))
			return new Response(mHttpUrlConnection.getResponseCode(), mInputStream, mHttpUrlConnection.getHeaderFields(), mRequest.encode(), mHttpUrlConnection.getContentLength());
		else
			return new Response(serviceId, mHttpUrlConnection.getResponseCode(), mInputStream, mHttpUrlConnection.getHeaderFields(), mRequest.encode(), mHttpUrlConnection.getContentLength());
	}
