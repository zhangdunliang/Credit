 ...
 * @作者:xiaochangyou
 * @版本:V1.0
 * @创建时间:2016-8-16 下午4:44:20
 * @描述:TODO[对android 的AsyncTask 进行覆盖，解决线程池限制问题; 注意！专门给上传信息用的,其他接口不可调用]
 * 
 */
public abstract class NoConfineAsyncTask<Params, Progress, Result> {
	private static final String LOG_TAG = "AsyncTask";

	//线程池的基本大小
	private static final int CORE_POOL_SIZE = 50;
	//线程池核心容量   使用了无界的任务队列这个参数就没什么效果
	 ...
	 */
	@SafeVarargs
	public final NoConfineAsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	public final NoConfineAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
	...
	private static class AsyncTaskResult<Data> {
		final NoConfineAsyncTask mTask;
		final Data[] mData;

		@SuppressWarnings("unchecked")
		AsyncTaskResult(NoConfineAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
