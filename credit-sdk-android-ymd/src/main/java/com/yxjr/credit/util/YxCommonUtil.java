...
public class YxCommonUtil {
    ...
    public static void processParam(Context context, Bundle bundle) {
        ...
        String channelNo = bundle.getString(YxConstant.CHANNEL_NO).trim();
        ...
        if (isSaveData(context, channelNo, partnerId, realName, idCardNum, phoneNumber, key, payPackageName, payClassName)) {
            YxStoreUtil.save(context, SpConstant.CHANNEL_NO, channelNo);
     ...
     */
    public static boolean isSaveData(Context context, String channelNo, String partnerId, String realName, String idCardNum, String phoneNumber, String key, String payPackageName, String payClassName) {
        if (YxStoreUtil.get(context, SpConstant.CHANNEL_NO).equals("") || YxStoreUtil.get(context, SpConstant.PARTNER_ID).equals("") || YxStoreUtil.get(context, SpConstant.PARTNER_REAL_NAME).equals("") || YxStoreUtil.get(context, SpConstant.PARTNER_ID_CARD_NUM).equals("")
            ...
            // 用户不是首次进来,没有存储过数据
            if (!YxStoreUtil.get(context, SpConstant.CHANNEL_NO).equals(channelNo) || !YxStoreUtil.get(context, SpConstant.PARTNER_ID).equals(partnerId) || !YxStoreUtil.get(context, SpConstant.PARTNER_REAL_NAME).equals(realName)
