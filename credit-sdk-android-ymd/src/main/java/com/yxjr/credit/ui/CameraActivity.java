...
import com.yxjr.credit.util.OldCamera;
...
public class CameraActivity extends Activity {
	...
	private void find() {
		mSelect = (ImageView) findViewById(R.id(selectID));
		mSelect.setVisibility(View.GONE);
		mSelect.setOnClickListener(clickListener);
		mAgain = (ImageView) findViewById(R.id(againID));
		mAgain.setVisibility(View.GONE);
		mAgain.setOnClickListener(clickListener);
		mTake = (ImageView) findViewById(R.id(takeID));
		mTake.setOnClickListener(clickListener);
		mTextureView = (TextureView) findViewById(R.id(textureID));
		mTextureView.setSurfaceTextureListener(surfaceTextureListener);
		mTextureView.setOnClickListener(clickListener);
		mTextureView.setKeepScreenOn(true);
		mCancel = (TextView) findViewById(R.id(cancelID));
		mCancel.setOnClickListener(clickListener);
		mPreview = (ImageView) findViewById(R.id(previewID));
		mPreview.setScaleType(ScaleType.FIT_XY);
		mChange = (ImageView) findViewById(R.id(changeID));
	...
	private void init() {
		...
		if (mIsVertical) {
			...
			RelativeLayout rlPreview = (RelativeLayout) findViewById(R.id(rlPreviewID));
			RelativeLayout rightFunction = (RelativeLayout) findViewById(R.id(rlRightFunctionID));
			RelativeLayout cancelSelect = (RelativeLayout) findViewById(R.id(rlCancelSelectID));
			RelativeLayout noselectChange = (RelativeLayout) findViewById(R.id(rlNoselectChangeID));
			ImageView assist = (ImageView) findViewById(R.id(rlAssistID));
			...
			lprightFunction.setMargins(0, YxDensityUtil.dipToPx(this, 30), 0, YxDensityUtil.dipToPx(this, 30));
			...
			lpcancelSelect.rightMargin = YxDensityUtil.dipToPx(this, 30);
			...
			//不选择/切换
			RelativeLayout.LayoutParams lpnoselectChange = new RelativeLayout.LayoutParams(YxDensityUtil.dipToPx(this, 30), YxDensityUtil.dipToPx(this, 30));
			lpnoselectChange.leftMargin = YxDensityUtil.dipToPx(this, 30);
