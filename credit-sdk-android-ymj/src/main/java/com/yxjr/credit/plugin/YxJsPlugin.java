            ...
            switch (code) {
                ...
                case JsConstant.GET_USER_MSG:// 获取用户信息
                    ...
                    try {
                        ...
                        userMsg.put("supportSDKVersion", YxStoreUtil.get(mContext, SpConstant.SUPPORT_SDK_VERSION_YMJ));
                    } catch (JSONException e) {
                        // TODO Auto-generated catch block
                        YxLog.e("Exception:Error parsing js json!" + e);
                        e.printStackTrace();
                ...
                case JsConstant.REQUEST_SERVER:// 与Server通讯
                    if (serviceId != null) {
                        if (serviceId.equals(HttpConstant.Request.SUBMIT) || serviceId.equals(HttpConstant.Request.DEPOSIT_CONFIRM)) {
                            ...
                            //						if (serviceId.equals("2104")) {
                            //							try {
                            //								data.put("verifyResult", "666");
                            //							} catch (JSONException e) {
                            //								// TODO Auto-generated catch block
                            //								e.printStackTrace();
                            //							}
                ...
                case JsConstant.GET_PRODUCT_ID:// 获取产品ID
                    ...
                    if (null != productId && null != productIdChild) {
                        YxStoreUtil.save(mContext, SpConstant.PRODUCT_ID, "6003");
                        YxStoreUtil.save(mContext, SpConstant.PRODUCT_ID_CHILD, "600301");
                    }
