...
public class IDCardNewIndicator extends View {
	...
	private void init() {
		this.R = ResContainer.get(this.getContext());
		...
		mBitmap = BitmapFactory.decodeResource(getResources(), R.drawable("yxjr_credit_idcard_line"));
	}
	...
	private void initAnimator() {
		...
		mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(ValueAnimator animation) {
				...
				if (!isScanAnimator)
					isScanAnimator = true;
				mBitmapTop = mShowDrawRect.top + f;
				postInvalidate();
			}
		});
	}
