...
public interface HttpConstant {
    ...
    String SERVER_URL = BuildConfig.YMJ_SERVER_URL;
    String UPLOAD_URL = BuildConfig.YMJ_UPLOAD_URL;
    String WEB_URL = BuildConfig.YMJ_WEB_URL;
    String EXAMPLE_URL = BuildConfig.YMJ_EXAMPLE_URL;
    String SYS_UPDATE_URL = BuildConfig.YMJ_SYS_UPDATE_URL;
    String USUAL_QUESTION_URL = BuildConfig.YMJ_USUAL_QUESTION_URL;
    String PULL_TIME_URL = BuildConfig.YMJ_PULL_TIME_URL;

    //
    String CHARSET = "UTF-8";
    int CONN_TIME_OUT = 120;
    int SOCKET_TIME_OUT = 120;
    String SSL_PROCESS = "http.server.ssl.process";
    ...
    String CONTENT_TYPE_FORM = "content-Type";
    //		String APP_XML_TYPE = "application/xml";
    String APP_JSON_TYPE = "application/json";
    //		String APP_DATA_TYPE = "multipart/form-data";
    String APP_DEF_TYPE = "application/plain";
    String APP_FILE_TYPE = "application/octet-stream";
