 ...
 * @描述:TODO[地区选择器]
 */
public class YxDialogSelectAddress implements View.OnClickListener {
	...
	public YxDialogSelectAddress(Activity mActivity) {
	...
	private View setDataPick() {
		View view = mInflater.inflate(R.layout("yxjr_credit_address_item"), null);
